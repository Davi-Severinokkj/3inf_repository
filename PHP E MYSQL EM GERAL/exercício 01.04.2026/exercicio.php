...
$finaldesemana = "O meu final de semana passado foi muito bom! Tivemos uma conferência de voluntários na igreja e foi bastante legal (mesmo havendo alguns impecílios). ";

echo "Questão 1: " . "<br>" . "Essa frase contém " . strlen($finaldesemana) . " caracteres.";
echo "<br>----------------------------------------------------------------------------------<br>";

echo "Questão 2: " . "<br>" . "MAIÚSCULAS: " . strtoupper($finaldesemana) . "<br>";
echo "<br>";
echo "minúsculas: " . strtolower($finaldesemana);
echo "<br>----------------------------------------------------------------------------------<br>";
echo "Questão 3: " . "<br>" . "Inversão: " . strrev($finaldesemana) . "<br>";
echo "<br>----------------------------------------------------------------------------------<br>";
echo "Questão 4: " . "<br>" . strpos($finaldesemana, "semana") . "<br>";
echo "<br>----------------------------------------------------------------------------------<br>";
echo "Questão 5: " . "<br>" . str_replace($finaldesemana, "semana", "aaaaaaaaaa") . "<br>";
echo "<br>----------------------------------------------------------------------------------<br>";
$finaldesemana_dois = "               O  meu  final  de  semana  passado foi muito bom! Tivemos uma conferência de voluntários na igreja e foi bastante legal (mesmo havendo alguns impecílios).                       " ;

echo "Questão 6: " . "<br>" . trim($finaldesemana_dois) ;
echo "<br>----------------------------------------------------------------------------------<br>";
$texto = "Eu sou muito legal!";
$a = explode(" ", $texto);
echo "Questão 7: " . "<br>";
print_r($a);
echo "<br>----------------------------------------------------------------------------------<br>";
...
echo "<br>----------------------------------------------------------------------------------<br>";
echo "Questão 9: " . "<br>";
echo "Há " . str_word_count($finaldesemana) . " palavras " . "na frase: " . $finaldesemana . "<br>";
echo "<br>----------------------------------------------------------------------------------<br>";
$frase = "ser ou não ser, eis a questão";
echo "Questão 10: " . "<br>" . ucwords($frase) . "<br>";